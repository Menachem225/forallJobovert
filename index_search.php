	            ...
	            <div class="row justify-content-center d-flex">
	                <div class="col-lg-8 post-list">
	                    ...
	                    <?php
                          ...
                          //  $sql_login="SELECT * FROM metier where id = '$numero' or ville where id ='$ville'  or salaire where id ='$valeur'";     
                          $sql_login="SELECT * FROM metier where metier like '%$numero%'";  
