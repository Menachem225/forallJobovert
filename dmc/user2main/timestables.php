                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <a href="../user/home.php" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i
                                        class="fa fa-plus"></i> Retour</a>
                            </div>
                            <div class="box-body">
...
<td><button class='btn btn-success btn-sm download btn-flat' ><i class='fa fa-edit'></i> Telecharger</button>
                          </td> </tr>
