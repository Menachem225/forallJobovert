<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>ACCEUIL</span></a></li>
      <li class=""><a href="#profile" data-toggle="modal"><span class="glyphicon glyphicon-lock"></span> <span>PARAMETRE</span></a></li>
