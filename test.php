	...
	<body>
	        ...
	        <div class="container">
	            <div class="row fullscreen d-flex align-items-center justify-content-center">
	                <div class="banner-content col-lg-12">
	                    ...
	                    <form method="GET" action="index_search.php" class="serach-form-area">
	                        <div class="row justify-content-center form-wrap">
                              ...
                              <option value='" . $row['idcat'] . "'>" . $row['metier'] . "</option>
                            ";
                                }
                                ?>
	                                </select>
	                                ...
	                                <div class="default-select" id="default-selects2">
	                                    <select name="salaire">
                                         ...
                                         echo "
	                                            ...
	                                            <option value='" . $row['id'] . "'>" . $row['valeur'] . "</option>
                            ";
                                }
                                ?>
	                                    </select>
	    ...
	    <section class="post-area section-gap">
            ...
            include ('connexion.php');
            $sql_login = "SELECT * FROM metier where ville = 'Abidjan' and idcat = '4' "; 
	                        ...
	                        <div class="details">
	                            <div class="title d-flex flex-row justify-content-between">
	                                ...
	                                <ul class="btns">
	                                    ...
	                                    <li><a href="formulaire.php">Postuker</a></li>
	                                </ul>
	                            </div>
	                            <p>
	    ...
	    function getRow(id) {
	        $.ajax({
	            ...
	            success: function(response) {
	                $('.id').val(response.id);
	                $('#edit_metier').val(response.description);
