      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Faire une demande</p><!--CReer le formualire a partir des donnéés admin -->
            </div>
            <div class="icon">
              <i class="fa fa-tasks"></i>
            </div>
            <a href="#financier" data-toggle="modal" class="small-box-footer" id="admin_profile">Cliquez <i class="fa fa-arrow-circle-right"></i></a>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="position.php" class="small-box-footer">Cliquez <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
