    ...
    <div class="wrapper">
      ...
      ?>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-aqua">
                            <div class="inner">
                                <?php
              $id="'".$_SESSION['student']."'";
              $sql = "SELECT * FROM fquery where id =$id";
              ...
              ?>
                                ...
                                <!--CReer le formualire a partir des donnéés admin -->
                            </div>
                            <div class="icon">
                                <i class="fa fa-tasks"></i>
                            </div>
                            <a href="#quete" data-toggle="modal" class="small-box-footer" id="admin_profile">Cliquez <i
