                ...
                <div class="row">
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-blue">
                            <div class="inner">
                                <?php
                $sql = "SELECT * FROM fquery where statut='en cours' AND service ='sinfo' ";
                $query = $conn->query($sql);

                echo "<h3>".$query->num_rows."</h3>";
              ?>

                                <p>Faire une demande au service informatique </p>
                            </div>
                            <div class="icon">
                                <i class="fa fa-black-tie"></i>
                            </div>
                            <a href="#sinfor" data-toggle="modal" class="small-box-footer" id="admin_profile">Cliquez
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-green">
                            <div class="inner">
                                <?php
              $id="'".$_SESSION['student']."'";
              $sql = "SELECT * FROM fquery where service ='sinfo' and id =$id";
                $query = $conn->query($sql);
